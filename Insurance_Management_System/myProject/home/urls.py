...
#Customer
    ...
    path('satffhome/',views.staffhome,name="staffhome"),
...
# Staff Policy Issue
    ...
    path('agent_health-plans01/<int:plan_id>/register/', views.agent_register_healthpolicy01, name='agent_register_healthpolicy01'),
    path('agent_health-plans02/<int:plan_id>/register-members/', views.agent_register_healthpolicy02, name='agent_register_healthpolicy02'),
    path('agent_submit/', views.agent_submit_member_form, name='agent_submit_member_form'),
    path('agent_health-plans03/<int:plan_id>/register-healthpolicy03/', views.agent_register_healthpolicy03, name='agent_register_healthpolicy03'),
    ...
    path('agent_select_customer_vehicle/', views.agent_select_customer_vehicle, name='agent_select_customer_vehicle'),
    path('agent_register_vehicle_policy/', views.agent_register_vehicle_policy, name='agent_register_vehicle_policy'),
    path('agent_policy_success/', views.agent_policy_success, name='agent_policy_success'),
    path('agent_vehicle_premium_payment/', views.agent_vehicle_premium_payment, name='agent_vehicle_premium_payment'), 
    path('agent_paymenthandler/', views.agent_paymenthandler, name='agent_paymenthandler'),
    path('agent_policy/qr/',views.agent_generate_policy_qr, name='agent_policy-qr'),
    path('agent_download_pdf/<int:policy_id>/', views.agent_generate_policy_pdf, name='agent_vehicle_generate_policy_pdf'),
