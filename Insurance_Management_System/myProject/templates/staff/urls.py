...
# Staff Policy Issue
    ...
    # path('staff-policy_success/', views.staff-policy_success, name='staff-policy_success'),
    # path('staff-vehicle_premium_payment/', views.staff-customer_vehicle_premium_payment, name='staff_vehicle_premium_payment'), 
    # path('paymenthandler/', views.paymenthandler, name='paymenthandler'),
    # path('staff-policy/qr/',views.staff-generate_policy_qr, name='staff-policy-qr'),
    # path('staff-download_pdf/<int:policy_id>/', views.tsaff-generate_policy_pdf, name='staff-vehicle_generate_policy_pdf'),
